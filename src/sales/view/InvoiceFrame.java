 ...
 * @author IslamAmin
*/
import sales.controller.Saleslistene;
import com.sales.model.InvoiceHeader10;
import com.sales.model.InvHeadTable2;
...
public class InvoiceFrame extends javax.swing.JFrame {
    ...
    private Saleslistene controller = new Saleslistene(this);
    private InvHeadTable2 invoicesTableModel;
    
    

    public ArrayList<InvoiceHeader10> getInvoices() {
        if (invoices == null) invoices = new ArrayList<>();
        return invoices;
    }

    public void setInvoices(ArrayList<InvoiceHeader10> invoices) {
        this.invoices = invoices;
    }
    
     public InvHeadTable2 getInvoicesTableModel() {
         if (invoicesTableModel == null) {
            invoicesTableModel = new InvHeadTable2(getInvoices());
        }
        return invoicesTableModel;
    }

    public void setInvoicesTableModel(InvHeadTable2 invoicesTableModel) {
    ...
    public Saleslistene getController() {
        return controller;
    }
     ...
     public int getNextInvoiceNum() {
        ...
        for (InvoiceHeader10 invoice : getInvoices()) {
